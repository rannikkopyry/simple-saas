  ...
  try {
    ...
    const supabase = (0, import_auth_helpers_shared.createServerSupabaseClient)({
      ...
      setCookie(name, value, options2) {
        const newSessionStr = (0, import_auth_helpers_shared.serializeCookie)(name, value, __spreadProps(__spreadValues({}, options2), {
          httpOnly: false
        }));
    ...
    if (error) {
      throw new Error(`Authorization error, redirecting to login page: ${error.message}`);
    } else if (!session) {
    ...
    try {
      ...
      const supabase = (0, import_auth_helpers_shared2.createServerSupabaseClient)({
        ...
        setCookie(name, value, options) {
          var _a, _b;
          const newSetCookies = (0, import_auth_helpers_shared2.filterCookies)((0, import_auth_helpers_shared2.ensureArray)((_b = (_a = context.res.getHeader("set-cookie")) == null ? void 0 : _a.toString()) != null ? _b : []), name);
          const newSessionStr = (0, import_auth_helpers_shared2.serializeCookie)(name, value, __spreadProps(__spreadValues({}, options), {
            httpOnly: false
          }));
  ...
  return async (req, res) => {
    try {
      ...
      const supabase = (0, import_auth_helpers_shared3.createServerSupabaseClient)({
        ...
        setCookie(name, value, options2) {
          var _a, _b;
          const newSetCookies = (0, import_auth_helpers_shared3.filterCookies)((0, import_auth_helpers_shared3.ensureArray)((_b = (_a = res.getHeader("set-cookie")) == null ? void 0 : _a.toString()) != null ? _b : []), name);
          const newSessionStr = (0, import_auth_helpers_shared3.serializeCookie)(name, value, __spreadProps(__spreadValues({}, options2), {
            httpOnly: false
          }));
...
function createServerSupabaseClient4(context, {
  ...
  return (0, import_auth_helpers_shared4.createServerSupabaseClient)({
    ...
    setCookie(name, value, options) {
      var _a, _b;
      const newSetCookies = (0, import_auth_helpers_shared4.filterCookies)((0, import_auth_helpers_shared4.ensureArray)((_b = (_a = context.res.getHeader("set-cookie")) == null ? void 0 : _a.toString()) != null ? _b : []), name);
      const newSessionStr = (0, import_auth_helpers_shared4.serializeCookie)(name, value, __spreadProps(__spreadValues({}, options), {
        httpOnly: false
      }));
