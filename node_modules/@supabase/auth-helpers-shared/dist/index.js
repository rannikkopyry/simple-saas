...
__export(src_exports, {
  ...
  isBrowser: () => isBrowser,
  parseCookies: () => import_cookie2.parse,
  serializeCookie: () => import_cookie2.serialize
});
...
function createBrowserSupabaseClient({
  ...
  return (0, import_supabase_js.createClient)(supabaseUrl, supabaseKey, __spreadProps(__spreadValues({}, options), {
    auth: {
      storageKey: name,
      storage: {
        getItem(key) {
...
function createServerSupabaseClient({
  ...
  return (0, import_supabase_js2.createClient)(supabaseUrl, supabaseKey, __spreadProps(__spreadValues({}, options), {
    auth: {
